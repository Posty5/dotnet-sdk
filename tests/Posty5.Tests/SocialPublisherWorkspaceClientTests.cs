...
public class SocialPublisherWorkspaceClientTests : IDisposable
{
    ...
    public async Post GetForNewPost_WithValidId_ShouldReturnWorkspaceWithAccounts()
    {
        ...
        var createRequest = new SocialPublisherWorkspaceCreateRequestModel
        {
            Name = "Workspace for GetForNewPost Test" + new Random().Next(),
            Description = "Testing getForNewPost operation",
            Tag = "new-post-test"
        };
    ...
    //    {
    //        await _client.GetForNewPostAsync("invalid-workspace-id-12345");
    //    });
    //}
